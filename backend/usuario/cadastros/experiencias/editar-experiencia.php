...
$select = "SELECT * from experiencia WHERE id = $id";
...
<div class="container">
    <form action="editar.php" method="post">
        <label for="funcao">Função na empresa:</label><br>
        <input name="funcao" type="text" value="<?=$linha['funcao']?>">
        <br>
        <label for="empresa">Empresa: </label><br>
        <input name="empresa" value="<?=$linha['empresa']?>" type="text">
        <br>
        <label for="carga">Periodo:</label><br>
        <input name="carga" value="<?=$linha['periodo']?>" type="text">
        <br>
